    ...
    return (
        ...
        <nav className="shadow-md  p-3 top-0 sticky z-10 bg-neutral-800">
            <div className="flex justify-between items-center max-w-4xl mx-auto">
                <h1 className="lg:text-3xl text-xl text-[#fde4c3] font-merienda">ClubMate</h1>
                    ...
                    <div className="w-8 h-8 cursor-pointer">
                        {
                            ...
                            <>
                            {
                                authUser.user?.img !== ""
                                ?
                                <Link to={`/profile/${authUser.user?.username}`}><img className='object-cover w-8 h-8 rounded-full' src={authUser.user?.img} alt="profile-img" /></Link>
                                :
